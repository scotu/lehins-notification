...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notification_noticesetting', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default=UUID('18289300-0593-43bc-a3a5-9acccc309506'), max_length=36)),
        ))
    ...
    models = {
        ...
        u'notification.noticesetting': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('77184b8c-024e-4add-b9bd-b78eeba1a848')", 'max_length': '36'})
        },

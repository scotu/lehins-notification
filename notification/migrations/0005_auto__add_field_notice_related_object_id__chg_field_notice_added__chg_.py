...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notice.related_object_id'
        db.add_column(u'notification_notice', 'related_object_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'Notice.added'
        db.alter_column(u'notification_notice', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ObservedItem.added'
        db.alter_column(u'notification_observeditem', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Notice.related_object_id'
        db.delete_column(u'notification_notice', 'related_object_id')


        # Changing field 'Notice.added'
        db.alter_column(u'notification_notice', 'added', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ObservedItem.added'
        db.alter_column(u'notification_observeditem', 'added', self.gf('django.db.models.fields.DateTimeField')())
